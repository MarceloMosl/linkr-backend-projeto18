...
async function signUp (req, res) {
    ...
    try {
        ...
        VALUES ($1, $2, $3, $4);`, [username, email, hashPassword, user_url]);
...
console.log(req.body)
        ...
        try {
            ...
            const sessaoAberta= await db.query (`SELECT * FROM sessions WHERE user_id=$1;`, [id])

            if (sessaoAberta.rowCount >=1) {
                await db.query (`UPDATE sessions SET token = $1 WHERE user_id = $2;`, [token, id])
            }else{
